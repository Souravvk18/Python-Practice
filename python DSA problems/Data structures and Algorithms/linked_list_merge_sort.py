...
def merge(left, right):
    """
    Merges two linked lista ,sorting by data in nodes returns a new merged list
    """
    ...
    #iterating over left and right until we reach the tail node of either.
...
'''It shwoing some error--

[Head: 100]-> [15]-> [44]-> [2]-> [Tail: 10]
